        ...
        <div className="menu-container">
            <div className="menu">
                ...
                <NavigateElement
                    ...
                    to="/Оплата"
                />
                <HashLink to="/#bookmark-contacts" className='menu_elem'>Контакты</HashLink>
                <HashLink to="/#bookmark-about" className='menu_elem'>О нас</HashLink>
                <div className='instagram'>
                    <Image src={Inst} alt="instagram" />
                    <p>Подписывайтесь на наш Instagram 
                        <a href="https://www.instagram.com/santexnika.by/" target="_blank">  @santexnika.by  </a>
                         и первыми узнавайте обо всех скидках и новинках нашего магазина cантехники SOQO.</p>
                </div>
