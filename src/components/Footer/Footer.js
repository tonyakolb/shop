      ...
      <div className="footer-info">
        <div className="footer-contacts">
          <div className="footer-column">
            <p className="column-name">Меню сайта</p>
            <div className="column-info">
              <ul>
                ...
                <li className="contacts-link">
                  {" "}
                  <a href="#bookmark-contacts" className="mobile-cont">
                    {" "}
                    Контакты{" "}
                  </a>{" "}
                </li>
          ...
          <div className="footer-column">
            ...
            <div className="column-info">
              <div className="social-nets">
                <a
                  href="https://www.instagram.com/santexnika.by/"
                  target="_blank"
                >
        ...
        <div className="shop-about">
          ...
          <p>
            {" "}
            Юр.адрес: 223021, Минская обл., Минский р-н, Щомыслицкий с/с, район
            агрогородка Озерцо, тракт Меньковский, 2. Пом. 781. Зарегистрирован
            в торговом реестре 29 июля 2022 года в администрации Советского
            района города Минска № 538673. Свидетельство о регистрации выдано 27
            января 2022 года УНП 693159769{" "}
          </p>
          <p>
            {" "}
            Указанные контакты также являются контактами для связи по вопросам
            покупателей о нарушении их прав. Номер телефона работников местных
            исполнительных и распорядительных органов по месту государственной
            регистрации ООО “Чайна Сантехника”, уполномоченных рассматривать
            обращения покупателей: +375 17 500 41 25.{" "}
          </p>
        </div>
      </div>
    </div>
