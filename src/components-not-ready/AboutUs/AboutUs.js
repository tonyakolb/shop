        ...
        <div className='about-us'>
            ...
            <div className='company-awards'>
                <div className='award'>
                    ...
                    <p>Ассоциация производителей сантехники Веньчжоуской зоны экономического и технологического развития 2018 г</p>
                </div>
                <div className='award'>
                    <img src={SecondImage} alt="award" />
                    <p>Почетная грамота<br />
                        Качественный сервис и репутация<br />
                        Спасибо за Ваше любезное спонсорство и общее развитие<br />
                        сентябрь 2014 
                     </p>
                </div>
                <div className='award'>
                    ...
                    <p>Почетная грамота<br />
                        Качественный сервис и репутация<br />
                        Предприятие уровня АААА<br />
                        Китайская ассоциация по качеству и безопасности продукции 2015г.</p>
                </div>
                <div className='award'>
                    <img src={ForthImage} alt="award" />
                    <p>Почетная грамота<br />
                        Качественное и честное<br />
                        Отличное модельное предприятие<br />
                        Китайская ассоциация по качеству и безопасности продукции 2015г.</p>
                </div>
                <div className='award'>
