            ...
            <div className='delivery'>
                ...
                <div className='delivery-ways'>
                    <div>
                        ...
                        <div className='delivery-way'>
                            ...
                            <ul>
                                <li>Курьерская доставка осуществляется по городу Минску (до 2 МКАД)</li>
                                <li>срок доставки 1-3 рабочих дня после подтверждения заказа;</li>
                ...
                <div className='delivery-post'>
                        ...
                        <ul>
                            ...
                            <li>Оплата за товар производится при получении посылки в Вашем отделении почты.</li>
                            <li>Стоимость доставки оплачивает покупатель согласно тарифам РУП &laquo;Белпочта&raquo;. </li>
                            <li>Оплата за товар производится при получении посылки в Вашем отделении почты.</li>
                            <li>Ознакомиться с тарифами можно по ссылке <a href="https://belpost.by/"> https://belpost.by/ </a>  </li>
                            <li>Ответственность за сроки доставки товаров и сохранность БЕЛПОЧТОЙ интернет-магазин не несет.</li>
